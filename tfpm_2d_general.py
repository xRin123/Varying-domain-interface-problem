...
def main():
    u = []
    #for i in range(5000):#np.random.randint(5000)
        #if i % 100 == 0:
            #print(i)
    i = 0#np.random.randint(5000)
    n = 51
    ...
    #interface = np.load('../data/square/general/area_xy.npy')[i]
    ...
    c = np.load('../data/square/general/tfpm_c.npy')[i]
    ...
    #np.save('../data/square/hf_5000/solve_general', u)
